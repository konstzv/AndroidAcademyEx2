...
class SpecialNewsViewFragmentToolbar : MvpAppCompatFragment(),SpecialNewsFragmentToolbarView{
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.specific_news_view_fragment_toolbar,container,false)
    }
